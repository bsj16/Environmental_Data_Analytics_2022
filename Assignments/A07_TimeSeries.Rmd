...
```{r}
#7
Ozone.ts <- ts(GaringerOzone$Ozone, start = c(2010,1),
            frequency= 365) 
plot(Ozone.ts)

```

>Answer: Based on this time series plot, the ozone concentration is higher in 2010-2012, then decreases in following years. This plot also shows that the ozone concentrations increase and then decrease each year.
