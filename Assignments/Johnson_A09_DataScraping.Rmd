...
ggplot(monthly.withdrawal.data, aes(x=Date, y = Max.Monthly.Withdrawals)) +geom_line() + 
  labs(y = "Maximum Monthly Withdrawal", title = paste("2020 Water Withdrawal Data for",water.system.name))
...
geom_line() + labs(title="Maximum Daily Withdrawals in 2015") + theme(plot.title = element_text(hjust=0.5)) + labs(color= "Water System", y = "Maximum Daily Withdrawals")
