...
counties_sf_join <-  merge(x = counties_sf,
                           y = svi2018_nc_raw, 
                           by.x = "GEOID", 
                           by.y = "FIPS" ) #geometry is preserved as well
...
wind.energy <-read.csv('https://raw.githubusercontent.com/ENV859/EnviroAtlasData/main/Wind_Energy.csv',
...
huc8_sf_wind <- huc8_sf %>%
  left_join(wind.energy, by = c('HUC_8','HUC_8'))
