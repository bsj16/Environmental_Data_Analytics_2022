...
* R Markdown allows you to have text and code in one place
* Good for reproducibility 
* Can integrate data and visualizations easily through knitting
* User friendly
...
dataset.column1 <- c("EcoTox_Neonicotinoids_Insects", "EPAair_O3", "EPAair_PM25", "NEON_NIWO_Litter", "NTL-LTER_Lake", "SVI2018_NORTHCAROLINA_county", "USGS_Site02085000_Flow")
