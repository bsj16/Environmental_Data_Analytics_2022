...
Factor-quantity under examination in an experiment
...
#Shapiro test allows us to compare means among different observations. Group letters are randomly assigned 
...
# Post-hoc test explores differences between multiple group means
...
Litter.interaction <- with(Litter, interaction(functionalGroup, nlcdClass)) #treatment group with interaction 

Litter.test <- cbind(Litter,Litter.interaction)

Litter.anova.2way5 <- aov(data = Litter, dryMass ~ Litter.interaction) #compare means for litter interaction levels 
