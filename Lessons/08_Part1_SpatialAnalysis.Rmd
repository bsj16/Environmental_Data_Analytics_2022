...
GasPlants <- st_read('https://opendata.arcgis.com/datasets/a0722062315143a7980cebb79a204781_4.geojson') #download dataset from a website 
#Alternative
...
EPAair.sf <- EPAair.sites %>% 
  st_as_sf(coords = c('SITE_LONGITUDE','SITE_LATITUDE'),
           crs=4326) #longitude is x, latitude is y -> lat and long are in one column 
...
the_buffer <- sf_GraingerHall %>% st_buffer(1) #1 degree of lat or long
