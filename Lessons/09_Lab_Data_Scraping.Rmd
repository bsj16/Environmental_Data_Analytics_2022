...
theURL.2 <- 'https://waterdata.usgs.gov/nwis/uv?search_site_no=02085070&period=24&format=rdb' #change period in this line 

#Get the data, which starts on line 30
gage_data <- read.table(theURL.2,skip = 29,header=TRUE,sep='\t') 
...
the_dfs <- lapply(X = the_years, FUN = scrape.it) %>% bind_row()
