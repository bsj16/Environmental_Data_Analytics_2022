...
*Residual error should follow a normal distribution so it is symmetric* 
*R-squared: amount of variable, R-squared shows how well the x variable fits to the y variable. X variable shows X% of variability in y variable* 
